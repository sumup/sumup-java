...
public final class SumUpClient {
   ...
   */
  public com.sumup.sdk.events.EventsHandler eventsHandler(
      String secret,
      com.sumup.sdk.events.EventCallback<com.sumup.sdk.events.EventNotification> fallback) {
    return new com.sumup.sdk.events.EventsHandler(apiClient, secret, fallback);
  }

...
public class EventNotification {
  ...
  /**
   * Verifies and deserializes an event using the supplied API client for resource fetches. Prefer
   * the client's {@code parseEventNotification} method when handling incoming requests.
   *
  ...
  private static EventNotification parseBody(ApiClient client, byte[] body) {
    try {
      ...
      Class<? extends EventNotification> type =
          switch (root.path("type").asText("")) {
            case "members.created" -> MemberCreatedEvent.class;
            case "members.deleted" -> MemberDeletedEvent.class;
            case "members.updated" -> MemberUpdatedEvent.class;
            case "readers.created" -> ReaderCreatedEvent.class;
            case "readers.deleted" -> ReaderDeletedEvent.class;
            default -> EventNotification.class;
          };

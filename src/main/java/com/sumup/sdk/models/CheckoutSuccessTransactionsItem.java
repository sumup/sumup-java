...
public record CheckoutSuccessTransactionsItem(
    ...
    Float vatAmount) {
  /**
   * Creates a builder for CheckoutSuccessTransactionsItem.
   *
   * @return Builder that constructs immutable CheckoutSuccessTransactionsItem instances.
   */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for CheckoutSuccessTransactionsItem instances. */
  public static final class Builder {
    ...
    /**
     * Builds an immutable CheckoutSuccessTransactionsItem instance.
     *
     * @return Immutable CheckoutSuccessTransactionsItem.
     */
    public CheckoutSuccessTransactionsItem build() {
      return new CheckoutSuccessTransactionsItem(
          amount,
          authCode,
          currency,
          entryMode,

 ...
 */
public record CheckoutSuccess2(
    ...
    com.sumup.sdk.models.CheckoutSuccess2PaymentInstrument paymentInstrument,
     ...
     */
    com.sumup.sdk.models.CheckoutSuccessStatus status,

    /**
     * Transaction code of the successful transaction with which the payment for the checkout is
     * completed.
     */
     ...
     */
    java.util.List<com.sumup.sdk.models.CheckoutSuccessTransactionsItem> transactions,
  ...
  /**
   * Creates a builder for CheckoutSuccess2.
   *
   * @return Builder that constructs immutable CheckoutSuccess2 instances.
   */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for CheckoutSuccess2 instances. */
  public static final class Builder {
    ...
    private com.sumup.sdk.models.CheckoutSuccess2PaymentInstrument paymentInstrument;
    private String redirectUrl;
    private String returnUrl;
    private com.sumup.sdk.models.CheckoutSuccessStatus status;
    private java.util.List<com.sumup.sdk.models.CheckoutSuccessTransactionsItem> transactions;
    ...
    /**
     * Sets the value for {@code paymentInstrument}.
     *
     * @param paymentInstrument Details of the saved payment instrument created or reused during
     *     checkout processing.
     * @return This builder instance.
     */
    public Builder paymentInstrument(
        com.sumup.sdk.models.CheckoutSuccess2PaymentInstrument paymentInstrument) {
     ...
     *
     * @param redirectUrl URL where the payer is redirected after a redirect-based payment or SCA
     *     flow completes.
     * @return This builder instance.
     */
     ...
     * @return This builder instance.
     */
    public Builder status(com.sumup.sdk.models.CheckoutSuccessStatus status) {
      this.status = status;
      return this;
    }
    ...
    /**
     * Builds an immutable CheckoutSuccess2 instance.
     *
     * @return Immutable CheckoutSuccess2.
     */
    public CheckoutSuccess2 build() {
      return new CheckoutSuccess2(
          amount,
          checkoutReference,
          currency,
          customerId,

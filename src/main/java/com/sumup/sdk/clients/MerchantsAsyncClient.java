...
public final class MerchantsAsyncClient {
  ...
  /**
   * Creates a new MerchantsAsyncClient instance backed by the provided ApiClient.
   *
   * @param apiClient Configured API client used to send HTTP requests.
   */
  public MerchantsAsyncClient(ApiClient apiClient) {
   ...
   *     <p>Call the overload that accepts optional parameter objects or RequestOptions to customize
   *     headers, authorization, query values, or timeouts.
   * @return CompletableFuture resolved with com.sumup.sdk.models.Person parsed response.
   * @throws ApiException if the SumUp API returns an error.
   */
  public CompletableFuture<com.sumup.sdk.models.Person> getPerson(
      String merchantCode, String personId) throws ApiException {
   ...
   *     <p>Call the overload that accepts optional parameter objects or RequestOptions to customize
   *     headers, authorization, query values, or timeouts.
   * @return CompletableFuture resolved with com.sumup.sdk.models.ListPersonsResponseBody parsed
   *     response.
   * @throws ApiException if the SumUp API returns an error.
   */
  public CompletableFuture<com.sumup.sdk.models.ListPersonsResponseBody> listPersons(

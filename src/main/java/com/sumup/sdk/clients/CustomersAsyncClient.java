...
public final class CustomersAsyncClient {
  ...
  /**
   * Creates a new CustomersAsyncClient instance backed by the provided ApiClient.
   *
   * @param apiClient Configured API client used to send HTTP requests.
   */
  public CustomersAsyncClient(ApiClient apiClient) {
   ...
   * @throws ApiException if the SumUp API returns an error.
   */
  public CompletableFuture<Void> deactivatePaymentInstrument(String customerId, String token)
      throws ApiException {
    return deactivatePaymentInstrument(customerId, token, null);
  }
   ...
   * @throws ApiException if the SumUp API returns an error.
   */
  public CompletableFuture<Void> deactivatePaymentInstrument(
  ...
  public CompletableFuture<java.util.List<com.sumup.sdk.models.PaymentInstrumentResponse>>
      listPaymentInstruments(String customerId) throws ApiException {

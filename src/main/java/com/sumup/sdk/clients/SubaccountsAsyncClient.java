...
public final class SubaccountsAsyncClient {
   ...
   */
  public CompletableFuture<com.sumup.sdk.models.Operator> compatGetOperator(Integer operatorId)
      throws ApiException {
   ...
   * @throws ApiException if the SumUp API returns an error.
   */
  public CompletableFuture<com.sumup.sdk.models.Operator> compatGetOperator(
   ...
   * @throws ApiException if the SumUp API returns an error.
   */
  public CompletableFuture<com.sumup.sdk.models.Operator> createSubAccount(
   ...
   * @throws ApiException if the SumUp API returns an error.
   */
  public CompletableFuture<com.sumup.sdk.models.Operator> updateSubAccount(

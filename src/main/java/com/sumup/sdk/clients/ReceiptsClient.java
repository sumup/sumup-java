...
public final class ReceiptsClient {
  ...
  /**
   * Creates a new ReceiptsClient instance backed by the provided ApiClient.
   *
   * @param apiClient Configured API client used to send HTTP requests.
   */
  public ReceiptsClient(ApiClient apiClient) {
   ...
   */
  public com.sumup.sdk.models.Receipt get(String transactionId, String mid) throws ApiException {

...
public final class TransactionsAsyncClient {
   ...
   */
  public CompletableFuture<com.sumup.sdk.models.TransactionFull> get(String merchantCode)
      throws ApiException {
   ...
   * @throws ApiException if the SumUp API returns an error.
   */
  public CompletableFuture<com.sumup.sdk.models.TransactionFull> get(
      String merchantCode, GetTransactionV21QueryParams getTransactionV21) throws ApiException {
    return get(merchantCode, getTransactionV21, null);
  }
   ...
   * @throws ApiException if the SumUp API returns an error.
   */
  public CompletableFuture<com.sumup.sdk.models.ListTransactionsV21Response> list(
  ...
  public CompletableFuture<com.sumup.sdk.models.ListTransactionsV21Response> list(
    ...
    return list(merchantCode, listTransactionsV21, null);
  }

 ...
 */
public final class MembershipsAsyncClient {
  private final ApiClient apiClient;

  /**
   * Creates a new MembershipsAsyncClient instance backed by the provided ApiClient.
   *
   * @param apiClient Configured API client used to send HTTP requests.
   */
  public MembershipsAsyncClient(ApiClient apiClient) {
   ...
   *
   * @return CompletableFuture resolved with com.sumup.sdk.models.ListMembershipsResponse parsed
   *     response.
   * @throws ApiException if the SumUp API returns an error.
   */
  public CompletableFuture<com.sumup.sdk.models.ListMembershipsResponse> listMemberships()
      throws ApiException {
